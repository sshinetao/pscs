...
<title>PACS TEC后台 - <?php echo $title;?></title>
		...
		<div class="am-collapse am-topbar-collapse" id="topbar-collapse">
			...
			<ul
				...
				<li class="am-dropdown" data-am-dropdown><a
					...
					href="javascript:;"> <span class="am-icon-user"></span> <?php  ?> <span
				...
				<ul class="am-list admin-sidebar-list" style="height: 100%;">
					<li class="admin-parent"><a class="am-cf"
						data-am-collapse="{target: '#collapse-nav'}"><span
							class="am-icon-users"></span> 管理员中心 <span
							class="am-icon-angle-right am-fr am-margin-right"></span></a>
						<ul class="am-list am-collapse admin-sidebar-sub am-in"
							id="collapse-nav">
							<li><a href="index.php" class="am-cf"><span
									class="am-icon-list"></span> 用户列表</a></li>
							<li><a href="records.php"><span class="am-icon-list-ol"></span>
									会诊记录</a></li>
